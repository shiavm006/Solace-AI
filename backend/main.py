...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allow all for Railway health checks
...
# Include routers BEFORE startup event
app.include_router(auth.router, prefix="/api/auth", tags=["Authentication"])
app.include_router(checkin.router, prefix="/api/checkin", tags=["Check-ins"])

# Simple endpoints FIRST - these must work immediately
@app.get("/")
def root():
